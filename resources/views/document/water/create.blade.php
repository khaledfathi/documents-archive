@extends('layout.main')
@section('title', 'Create Water Doc')
@section('links', '')
@section('scripts')
...
@endsection
@section('sectionName', 'New Water Bill ')
@section('path')
...
@section('content')
    ...
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('document.water.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card-footer col-12">
                ...
                <a href="{{route('document.water.index').'?year='.CURRENT_YEAR }}" class="btn btn-danger">Cancle</a>
            </div>
        </form>
    </div>
@endsection

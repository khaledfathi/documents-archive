@extends('layout.main')
@section('title', 'Edit Electricity Doc')
@section('links', '')
@section('scripts')
...
@endsection
@section('sectionName', 'Edit Electricity Bill ')
@section('path')
...
@section('content')
    ...
    <div class="card card-success">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('document.electricity.update') }}" method="post" enctype="multipart/form-data">
            @csrf
